...
export class AuthController {
  constructor(private authService: AuthService, private userTokenService: UserTokenService, private storageService: StorageService) { }
  @Public()
  ...
  @Post("register")
  async signUp(@Body() createProfileDto: CreateProfileDto, @Req() request: Request) {
  ...
  resetPassword(@Body() resetPassword: Record<string, any>) {
    return this.userTokenService.resetPassword(resetPassword.userId, resetPassword.token, resetPassword.password);
  }
}